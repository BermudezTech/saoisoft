...
$fila = $st -> fetch();
 	...
 	<div class="contenedor">
 		...
 		<div class="main">
 			<div class="form">
 				...
 				<input type="submit" value="Regresar" class="button-submit-green" onclick="regresariframe()">
 				</form>
 			</div>
 		</div>
 		<div class="footer">
 ...
 <script>
 	function regresariframe(){
	const parentDocument = window.parent.document;
	parentDocument.getElementById('modal7').style.display = 'none';
	}
 </script>
 </body>
 </html>
