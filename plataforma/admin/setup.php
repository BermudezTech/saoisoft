	...
	<div class="contenedor">
		...
		<div class="body">
			...
			<div class="main">
				...
				-->
				<div class="span">Configuracion envio de correos electronicos</div>
				<form action="#"><br><br>
					<input type="checkbox" name="chk">
					<label for="chk">Enviar notificación a usuarios</label><br><br>
					<input type="checkbox" name="chk">
					<label for="chk">Enviar copia a la plataforma</label>
				</form>
			</div>
		</div>
	</div>
